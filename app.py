...
.hero {
  position: relative;
  padding: 1.95rem 0 2.75rem;
  min-height: 100%;
  display: flex;
  flex-direction: column;
  justify-content: center;
}
.hero-top { display: flex; align-items: center; gap: 0.7rem; margin-bottom: 1.25rem; }
...
with hero_left:
    ...
    <div class="hero">
      ...
      <h1 class="hero-title">
        <span class="line">First-Gen</span>
        <span class="line accent">Compass</span>
      </h1>
      <p class="hero-sub">
        A calm, intelligent map for students navigating college without inherited playbooks.
      </p>
    </div>
